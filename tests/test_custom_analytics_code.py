...
class TestCustomAnalyticsCode:
    ...
    async def test_basic_execution(self, sample_test_dataset):
        ...
        result = await execute_custom_analytics_code.fn(
            "test_custom",
...
"""
        result = await execute_custom_analytics_code.fn("test_custom", code)
...
"""
    ...
    async def test_empty_code(self, sample_test_dataset):
        ...
        result = await execute_custom_analytics_code.fn("test_custom", "")
